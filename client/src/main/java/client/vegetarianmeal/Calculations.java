...
public class Calculations {
    ...
    /**
     * this is the first calculation that is done.
     *      The Chosen food is looked up in the mealList
     *      and than the private values are updated
    ...
    /**
     * this is the second calculation that is done,
     * people also choose a bad food what they normally eat,
     * so the reduced CO2 can be calculated.
     */
    public int reducedCO2(String badFood, int chosenServingSize, double co2goodfood)
            throws IOException {
    ...
    /**this is the last calculation that is done,
     *the points for the user are calculated.
     */
