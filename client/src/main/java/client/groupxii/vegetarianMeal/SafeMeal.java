...
public class SafeMeal {
     ...
     * @throws IOException if it recives unexpected response
     */
    public String safeMeal(String goodFoodName, String badFoodName, int goodServingSize, int badServingSize) throws IOException {
        // Url were to get the JSON data from, "transport" is now hardcoded
        // but will be a variable in the future.
        URL url = new URL("http://" + host + ":" + port + "/saveMealData?goodFoodName=" + goodFoodName + "&goodServingSize="
                + goodServingSize + "&badFoodName=" + badFoodName + "&badServingSize=" + badServingSize );
        String readLine;
